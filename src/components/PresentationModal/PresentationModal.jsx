...
const PresentationModal = ({ isOpen, onClose, slides }) => {
  ...
  return (
    <div ref={modalRef} className={`${c.modal} ${isFullscreen ? c.fullscreen : ''}`}>
      <SlidesWrapper
        ...
        onNextSlide={currentSlide < slides.length ? nextSlide : null}
      />
      ...
      <div className={c.toolbar}>
        ...
        <button className={c.toolbarButton} onClick={nextSlide} disabled={currentSlide === slides.length}>
