export const data = [
  ...
  },
  {
    ...
    content: [
      {
        type: 'quote',
        quote: 'Experimentation is evolving from an enablement function into a strategic growth lever.',
      ...
      },
      {
        type: 'contentBlock',
        label: 'Glossary',
        title: 'Experimentation – Current state',
        content:
          'The Experimentation Practice operates as a <strong>Centre of Excellence</strong>, supporting optimisation, feature de-risking, and discovery validation across portfolios. It is not fully decentralised. Experimentation (A/B testing) remains a maturing capability and requires strong cross-functional collaboration across product, design, engineering, analytics, and delivery. Team members currently support feature de-risking, discovery validation, optimisation initiatives, and in some cases feature delivery. This context is critical when shaping future direction, resourcing, and focus models.',
      },
      {
        type: 'contentBlock',
        label: 'Goals',
        title: 'High-level goals',
        content: 'Our ambition is to evolve experimentation into a sustainable, high-impact business capability.',
        columns: { l: 2, md: 2, s: 1 },
        items: [
          {
            icon: 'FlaskConical',
            title: 'Validated value',
            text: 'Unlock measurable impact through validated learnings.',
          },
          {
            icon: 'TrendingUp',
            title: 'Sustainable culture',
            text: 'Mature toward a lasting culture of experimentation.',
          },
          {
            icon: 'Target',
            title: 'Enable WOO',
            text: 'Position experimentation as a key enabler of Winning Online Offer pillars.',
          },
          {
            icon: 'Scale',
            title: 'Strong principles',
            text: 'Establish consistent methodology and practice standards.',
          },
        ],
      },
      {
        type: 'contentBlock',
        label: 'Foundations',
        title: 'Proposed key adjustments',
        content:
          'Across all future options, several structural improvements are required to strengthen focus, clarity, and impact.',
        columns: { l: 2, md: 2, s: 1 },
        items: [
          {
            icon: 'RefreshCcw',
            title: 'Refine value recognition',
            text: 'Revisit and align the Value Recognition Framework with updated OKRs.',
          },
          {
            icon: 'ListTree',
            title: 'Growth backlog',
            text: 'Strengthen cross-portfolio idea pipeline and prioritisation.',
          },
          {
            icon: 'Users',
            title: 'Growth Council',
            text: 'Guide evaluation, traffic allocation, and impact reporting.',
          },
          {
            icon: 'Gauge',
            title: 'Rethink velocity targets',
            text: 'Remove velocity-based targets unless shifting to high-tempo growth.',
          },
        ],
      },
      {
        type: 'contentBlock',
        label: 'Option 1',
        title: 'Distributed enablement model',
        content:
          'Continue strengthening experimentation within persistent squads and portfolios. Squads retain individual focus areas while capability continues to mature in a distributed way.',
        columns: { l: 3, md: 3, s: 1 },
        items: [
          {
            icon: 'Network',
            title: 'Implication',
            text: 'Strong cultural momentum and capability uplift, with less concentrated commercial narrative.',
          },
        ],
      },
      {
        type: 'contentBlock',
        label: 'Option 2',
        title: 'Hybrid model (Distributed + high-leverage surface)',
        content:
          'Maintain distributed experimentation while introducing focused investment on high-leverage surfaces such as PDP. Close core capability gaps across training, governance, and standards.',
        columns: { l: 3, md: 3, s: 1 },
        items: [
          {
            title: 'T3',
            text: 'Continue squad focus areas, strengthen App & Growth portfolios, begin rapid PDP discovery (resourcing TBD).',
          },
          {
            title: 'T1',
            text: 'Allocate 2+ experimentation leads to PDP for 1–2 trimesters to drive focused growth.',
          },
          {
            title: 'Implication',
            text: 'Balanced capability building with concentrated commercial impact.',
          },
        ],
      },
      {
        type: 'contentBlock',
        label: 'Option 3',
        title: 'Concentrated growth focus',
        content:
          'Shift toward a focused growth model with experimentation leads consolidated against priority surfaces aligned to the Enhanced Discovery CX pillar (WOO).',
        columns: { l: 3, md: 3, s: 1 },
        items: [
          {
            title: 'T1–T2',
            text: 'Consolidate Discover experimentation leads with primary focus on PDP growth.',
          },
          {
            title: 'T3',
            text: 'Transition focus to next high-leverage surface, funnel step, or platform.',
          },
          {
            title: 'Implication',
            text: 'Maximum executive clarity and growth concentration, reduced distributed experimentation.',
          },
        ],
      },
      {
        type: 'quote',
        quote:
          'The next phase of experimentation is not about volume — it is about focus, leverage, and sustained impact.',
        highlightWords: ['focus', 'leverage', 'impact'],
        highlightColor: '#E44444',
        isTextInverted: true,
      },
    ],
